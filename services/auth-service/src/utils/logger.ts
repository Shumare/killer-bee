...
export type LogCategory =
  | 'connection'    // cycle de vie du service (start, stop, signal)
  | 'http'          // requêtes / réponses HTTP entrantes
  | 'access'        // authentification et autorisations
  | 'validation'    // validation des données d'entrée
  | 'communication' // erreurs réseau ou inter-services
  | 'routing'       // anomalies de routage
  | 'operation'     // opérations métier (CRUD)
  | 'audit'         // événements de sécurité traçables
...
export const log = createAppLogger('auth-service')
